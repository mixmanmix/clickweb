...
<?php
		...
		Template::includeTemplateHeaderBottom('About',array(array(Template::getPageURL('home',false),'Home'),array('#','About')));
?>
						...
						<div class="template-layout-50x50 template-clear-fix">
							...
							<div class="template-layout-column-left">
								...
								<div class="template-component-header-subheader template-align-left">
									<h2>ClickWash</h2>
									<div></div>
									<span>On-Demand Car Wash</span>
								</div>
								
								<!-- Text -->
								<p class="template-padding-reset">
									We operate on-demand car washes throught Vancouver, B.C area. 
